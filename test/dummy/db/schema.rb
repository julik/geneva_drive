...
ActiveRecord::Schema[8.1].define(version: 2024_12_17_000003) do
  ...
  create_table "geneva_drive_workflows", force: :cascade do |t|
    ...
    t.index ["type", "hero_type", "hero_id"], name: "index_geneva_drive_workflows_unique_ongoing", unique: true, where: "(((state)::text <> ALL (ARRAY[('finished'::character varying)::text, ('canceled'::character varying)::text])) AND (allow_multiple = false))"
